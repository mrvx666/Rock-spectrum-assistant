...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.clearButton, self.browserButton)
        MainWindow.setTabOrder(self.browserButton, self.treeView)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_2.setText(_translate("MainWindow", "窗口置顶"))
