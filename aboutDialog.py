...
class Ui_aboutDialog(object):
    def setupUi(self, aboutDialog):
        ...
        self.picturelabel.setPixmap(QtGui.QPixmap(":/image/鸽子楼.png"))
        ...
        self.geoicolabel.setGeometry(QtCore.QRect(370, 0, 100, 100))
        self.geoicolabel.setText("")
        self.geoicolabel.setPixmap(QtGui.QPixmap(":/image/院标(兰)xiao.png"))
        ...
        self.RSAtextlabel.setGeometry(QtCore.QRect(320, 110, 201, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
